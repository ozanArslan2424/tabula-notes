...
export const GoogleButton = () => {
  ...
  return (
    <Button className="w-full" type="button" variant="secondary" onClick={onGoogleLogin}>
      <GoogleLogoBold />
...
export const GithubButton = () => {
  ...
  return (
    <Button className="w-full" type="button" variant="secondary" onClick={onGithubLogin}>
      <GithubLogoBold />
